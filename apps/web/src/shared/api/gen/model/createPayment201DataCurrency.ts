...
export type CreatePayment201DataCurrency =
  (typeof CreatePayment201DataCurrency)[keyof typeof CreatePayment201DataCurrency];

export const CreatePayment201DataCurrency = {
  RUB: 'RUB',
} as const;
