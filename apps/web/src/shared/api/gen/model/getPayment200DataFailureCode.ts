 ...
 * @nullable
 */
export type GetPayment200DataFailureCode =
  (typeof GetPayment200DataFailureCode)[keyof typeof GetPayment200DataFailureCode] | null;

export const GetPayment200DataFailureCode = {
