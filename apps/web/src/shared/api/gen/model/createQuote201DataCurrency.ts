...
export type CreateQuote201DataCurrency =
  (typeof CreateQuote201DataCurrency)[keyof typeof CreateQuote201DataCurrency];

export const CreateQuote201DataCurrency = {
  RUB: 'RUB',
} as const;
