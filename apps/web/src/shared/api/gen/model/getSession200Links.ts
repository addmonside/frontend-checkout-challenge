 ...
 */
import type { GetSession200LinksMethod } from './getSession200LinksMethod';

export type GetSession200Links = {
  [key: string]: {
    /** @pattern ^/ */
    href: string;
    method: (typeof GetSession200LinksMethod)[keyof typeof GetSession200LinksMethod];
  };
};
