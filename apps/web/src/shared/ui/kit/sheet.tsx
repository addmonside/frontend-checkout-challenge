      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={<Button className="absolute top-3 right-3" />}
          >
            <XIcon />
...
function SheetContentContent<T extends React.ElementType = 'div'>({
  className,
  as,
  ...props
}: {
  ...
  return (
    <Component
      data-slot="sheet-content-content"
